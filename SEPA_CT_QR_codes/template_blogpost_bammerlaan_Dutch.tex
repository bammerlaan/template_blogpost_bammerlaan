...
%			&	\textbf{Totaal te voldoen met aftrek van korting} &  & &   &   &	& \euro{} @{cformat(amount_gross_ - Decimal('0.1') * amount_net_)}
	...
	\end{adjustwidth}	
		...
		\IfFileExists{/home/steelbas/Documents/Bestanden/Bestanden/bammerlaan\string_zangles/Gnucash\string_boekhouding/Facturen/LaTeX/QR\string_codes\string_SEPA/Factuur\string_@{id}\string_SEPACTQR.png}
		{
			Betalen kan ook door deze QR-code met de mobiele app van je bank te scannen:
			\begin{center}
				\includegraphics[width=4cm]{/home/steelbas/Documents/Bestanden/Bestanden/bammerlaan\string_zangles/Gnucash\string_boekhouding/Facturen/LaTeX/QR\string_codes\string_SEPA/Factuur\string_@{id}\string_SEPACTQR.png}
			\end{center}
		}
		{
			% (Run this if file is not present.)
		}
